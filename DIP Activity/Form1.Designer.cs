namespace DIP_Activity
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // ConvMatrix
            // 
            ConvMatrix.BackColor = SystemColors.GradientInactiveCaption;
            ConvMatrix.Font = new Font("Sigmar One", 9F, FontStyle.Regular, GraphicsUnit.Point, 0);
            ConvMatrix.Location = new Point(521, 17);
            ConvMatrix.Name = "ConvMatrix";
            ConvMatrix.Size = new Size(169, 35);
            ConvMatrix.TabIndex = 12;
            ConvMatrix.Text = "ConvMatrix";
            ConvMatrix.UseVisualStyleBackColor = false;
            ConvMatrix.Click += ConvMatrix_Click;
            // 
            // Form1
            // 
